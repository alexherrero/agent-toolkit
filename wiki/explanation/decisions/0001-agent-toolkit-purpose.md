...
> [!NOTE]
> **Status:** accepted · **Date:** 2026-05-20 · **Source:** [ROADMAP item #18](https://github.com/alexherrero/agentic-harness/blob/main/.harness/ROADMAP.md). Implemented in plan #18 (inserted mid-flight of plan #7a part 5). See `agent-toolkit/skills/memory/scripts/embed.py` v0.9.2+ for the implementation; this amendment captures the design rationale.
